...
/**
 * Entry point for DroidDoc library initialization.
 *
 * ```kotlin
 * // Commercial use: call once in Application.onCreate()
 * DroidDoc.initialize(context, licenseKey = "XXXXXXXX-XXXX-XXXX-XXXX")
 *
...
object DroidDoc {
    ...
    /**
     * Initialize DroidDoc with a Gumroad license key for commercial use.
     *
    ...
    // Gumroad product: https://y1uda.gumroad.com/l/droiddoc
    internal const val GUMROAD_PRODUCT_ID = "I0ns9F339epI42uxulrE6g=="
    private const val PREFS_NAME = "droiddoc_license"
}
